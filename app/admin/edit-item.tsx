...
import { ArrowLeft, Save, Image as ImageIcon, Camera, ChevronDown } from 'lucide-react-native';
...
export default function EditItemScreen() {
  ...
  useEffect(() => {
    ...
    const productId = global.productToEdit;
    if (productId) {
  ...
  const handleSubmit = () => {
    ...
    const updatedProduct = {
      ...
      rating: 4.0, // Maintain the same rating
    };
    
    try {
      // Update the product using the context function
      updateProduct(global.productToEdit, updatedProduct);
      
      // Show a brief success message
      Alert.alert("Success", "Product updated successfully");
      
      // Automatically redirect to the admin dashboard to see the updated product
      setTimeout(() => {
